...
//another shooping cart uses function to calculate total price
let shoppingCart2 =[
  { name: "Susi", price: 2, quantity: 1 },
  { name: "AhMok", price: 1, quantity: 3 },
  { name: "Noodle", price: 1.5, quantity: 2 },
]
let totalPrice2 = calculateTotalPrice(shoppingCart2);
console.log("Total price for shoppingCart2:", totalPrice2);
